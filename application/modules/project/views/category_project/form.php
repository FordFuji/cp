...
?>
							<form action="<?php echo site_url('project/backend/category_project_save_update/'.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
?>
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="file" name="category_project_file" id="category_project_file" class="form-control">
<?php
if(!empty($row)) {
	if($row->category_project_file != '') {
?>
									<br><img src="<?php echo base_url('uploads/project/'.$row->category_project_file);?>" width="150">
<?php
	}
}
?>           
					        ...
					        <div class="form-group">
					            ...
					            <div class="col-md-9">
									<input type="text" name="category_project_name" id="category_project_name" class="form-control" value="<?php if(!empty($row)) echo $row->category_project_name;?>" required>
					            </div>
					        </div>
					        <div class="form-group">
	...
	<script>
		...
		function resetForm() {
			$(".form-control").val('');
			CKEDITOR.instances.category_project_ckeditor.setData('');
		}
	</script>
</body>
</html>

...
?>
							<form action="<?php echo site_url('my_profile/backend/chat_save_update/'.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
?>           
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="file" name="chat_qr_code_image" id="chat_qr_code_image" class="form-control">
<?php
if(!empty($row)) {
	if($row->chat_qr_code_image != '') {
?>
									<br><img src="<?php echo base_url('uploads/profile/'.$row->chat_qr_code_image);?>" width="150">
<?php
	}
}
?>           
					        ...
					        <div class="form-group">
					            <label class="col-md-3 control-label">Application</label>
					            <div class="col-md-9">
                       				<input type="text" name="chat_application" id="chat_application" class="form-control" value="<?php if(!empty($row)) echo $row->chat_application;?>" required>
					            </div>
					        </div>
					        <div class="form-group">
	...
	<script>
		...
		function resetForm() {
			$(".form-control").val('');
			CKEDITOR.instances.chat_ckeditor.setData('');
		}
	</script>
</body>
</html>

...
?>
							<form action="<?php echo site_url('my_profile/backend/award_save_update/'.$id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
...
?>           
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="file" name="award_image" id="award_image" class="form-control">
<?php
if(!empty($row)) {
	if($row->award_image != '') {
?>
									<br><img src="<?php echo base_url('uploads/profile/'.$row->award_image);?>" width="150">
<?php
	}
}
?>           
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="text" name="award_name" id="award_name" class="form-control" value="<?php if(!empty($row)) echo $row->award_name;?>" required>
					            </div>
					        </div>
					        <div class="form-group">
	...
	<script>
		...
		function resetForm() {
			$(".form-control").val('');
			CKEDITOR.instances.award_ckeditor.setData('');
		}
	</script>
</body>
</html>

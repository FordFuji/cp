			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('my_profile/backend/education_form');?>';" style="margin-bottom: 10px;">Add</button>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var table = $('#data-table').DataTable({
				...
				processing: true,
				ajax: {
					url:'<?php echo site_url('my_profile/backend/education_server_processing'); ?>'
				},
				'columns':[
					{
						data:'education_id'
					...
					},
					{
						data:'action',
						render:function(data, type, row){
							var action = '<a href="<?php echo site_url('my_profile/backend/education_form');?>/' + row['education_id'] + '">Edit</a> / <a href="<?php echo site_url('my_profile/backend/education_delete');?>/' + row['education_id'] + '" onclick="return confirm(\'Confirm Delete\');">Delete</a>';

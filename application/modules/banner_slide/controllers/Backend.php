...
class Backend extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('banner_slide/model_banner_slide');
		$this->load->model('banner_slide/model_banner_slide_datatable');
	...
	public function index() {
		...
		/* start body */
		$this->load->view('banner_slide/banner_slide/list', $data);
		/* end body */
	}
	...
	public function server_processing() {
        ...
        $results = $this->model_banner_slide_datatable->banner_slide_datatable($param);
	...
	public function form($id = ''){	
		$data['id'] = $id;
		$data['row'] = $this->model_banner_slide->get_data_single($id);
		...
		$this->load->view('banner_slide/banner_slide/form', $data);
	}
	
	public function save_update($id = ''){	
		$data = array(
			'banner_slide_text1' => $this->input->post('banner_slide_text1'),
			'banner_slide_text2' => $this->input->post('banner_slide_text2'),
			'banner_slide_text3' => $this->input->post('banner_slide_text3'),
			'banner_slide_text4' => $this->input->post('banner_slide_text4'),
			'banner_slide_link' => $this->input->post('banner_slide_link'),
		...
		// update 
		if($id != '') {	
			$this->model_banner_slide->update_data($data, $id);
			
			redirect('banner_slide/backend/index', 'location');
			
		// insert
		} else {	
			$data['banner_slide_datetime_create'] = date('Y-m-d H:i:s');
				
			$this->model_banner_slide->insert_data($data);
	...
	public function delete($id){
		$this->model_banner_slide->delete_data($id);

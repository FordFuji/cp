			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('training/backend/form');?>';" style="margin-bottom: 10px;">Add</button>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var table = $('#data-table').DataTable({
				...
				processing: true,
				ajax: {
					url:'<?php echo site_url('training/backend/server_processing'); ?>'
				},
				'columns':[
					{
						data:'training_id'
					...
					{
						data:'training_date_begin'
					},
					{
						data:'training_date_end'
					},
					{
						data:'training_department'
					},
					{
					...
					{
						data:'training_description_grade'
					},
					{
						data:'action',
						render:function(data, type, row){
							var action = '<a href="<?php echo site_url('training/backend/form');?>/' + row['training_id'] + '">Edit</a> / <a href="<?php echo site_url('training/backend/delete');?>/' + row['training_id'] + '" onclick="return confirm(\'Confirm Delete\');">Delete</a>';
